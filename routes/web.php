...
Route::get('/Liste_Fournisseur', 'PartenaireController@Partenaire');
Route::post('/Ajout-F', 'PartenaireController@add_supplier');
Route::get('Fournisseur/supprimer','PartenaireController@destroy');
Route::get('/search_F', 'PartenaireController@search');
...
Route::post('/demande_partenaire','IndexController@demande_partenaire')->name('demande_partenaire');



//Statistique
Route::get('/home','StatController@statistique');
// Route::resource('DemandePartenaire',DemandePartController::class);
