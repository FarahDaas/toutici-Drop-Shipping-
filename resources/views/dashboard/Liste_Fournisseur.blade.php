                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <td>
                            ...
                            @if($part->id_user == $row->id)
                            <button type="button" class="btn btn-warning btn-rounded btn-icon" title="Voir détail" data-toggle="modal" data-target="#exampleModal" data-adresse="{{ $part->adresse }}" data-ville="{{ $part->ville }}" data-region="{{ $part->region }}" data-postal="{{ $part->postal }}" id="detail">
...
<div class="modal fade" id="Delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Êtes-vous sur de supprimer cet Partenaire ?</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
