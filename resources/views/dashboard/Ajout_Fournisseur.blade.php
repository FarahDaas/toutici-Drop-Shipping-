                      ...
                      <div>
                        ...
                        <section>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control required" placeholder=" Name de partenaire" name="nom">
                          </div>
                          <div class="form-group">
                        ...
                        <section>
                          <div class="form-group required {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="exampleInputUsername2">pseudo *</label>
                            
                              <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Nom Partenaire" name="name">
