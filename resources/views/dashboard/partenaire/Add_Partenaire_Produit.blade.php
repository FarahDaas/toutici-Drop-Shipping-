...
<div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ajouter Partenaire produit</h4>
                    <form id="example-form" method="POST" action="{{ route('partenaire_Produit.store') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <div>
                        {{-- <h3>Ajouter Partenaire service</h3> --}}
                        <section>
                          ...
                          <div class="form-group">
                            <label >Service *</label>
                            <input type="text" class="form-control required" id="exampleInputEmail2" name="service" placeholder="Service">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="add">CIN *</label>
                            <input type="text" class="form-control required" id="exampleInputPassword2" placeholder="Code postal" name="cin">
                          </div>
                          <div class="form-group">
                            <label for="add">Tel *</label>
                            <input type="text" class="form-control required" id="exampleInputPassword2" placeholder="Tel" name="tel">
                          </div>
                          <div class="form-group">
                      ...
                      <button type="submit" id="submitForm" class="btn btn-gradient-primary mr-2">Ajouter</button>
                    </form>
                  </div>
                </div>
              </div>
