                  ...
                  <div class="card-body">
                    ...
                    {{ csrf_field() }} 
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="exampleTextarea1" ></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Icon</label>
                        <input  class="form-control" type="file" name="icon" id="exampleTextarea1" req>
                      </div>
