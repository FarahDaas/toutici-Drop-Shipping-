          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/Liste_Fournisseur')}}">
                <span class="menu-title">Partenaire &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="commande">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{ url('/Commande_Fourni')}}">Commande Partenaire</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="devis">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ url('/Admin/devis')}}">Devis Partenaire</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="fact">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{ url('/LesFactureDuFournisseur')}}">Facture Partenaire</a></li>
