                      ...
                      <h1>Votre adresse :</h1><br>
                          ...
                          <div class="form-group">
                            <label>Région</label>
                              ...
                              <select class="form-control" name="region">
                                <option value="{{$Partenaire->region }}" selected>{{$Partenaire->region }}</option>
                          ...
                          <div class="form-group">
                            <label>Ville</label>
                              ...
                              <input type="text" class="form-control" name="ville" value="{{$Partenaire->ville }}" />
                          ...
                          <div class="form-group">
                            <label>Adresse</label>
                              ...
                              <input type="text" class="form-control" name="adresse" value="{{$Partenaire->adresse }}" />
                          ...
                          <div class="form-group">
                            <label>Code postale</label>
                              ...
                              <input type="text" class="form-control" name="postal" value="{{$Partenaire->postal }}" />
