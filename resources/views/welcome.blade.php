...
@section('content')
                ...
                <div class="inner-slide justify-content-center">
                    <div class="slide-content-2">
                        <div class="inner-content-2 text-center">
                            ...
                            <h1 class="white-title-color slider-head-1">TOUTICI</h1>
             ...
             <div class="slide-item bg-2 image-3-3 slide-left_center animation-style-01 parallax">
                <div class="inner-slide justify-content-center">
                    <!-- <div class="slider-content-2">
                        <div class="inner-content-2 text-center">
                            <h4 class="white-title-color slider-head-2 pb-10">La vie en or</h4>
                            <h1 class="white-title-color slider-head-1 pb-20">TOUTICI</h1>
        ...
        <div class="banner-item">
            <div class="banner-inner-item d-md-flex d-sm-block align-items-center">
                <div class="banner-img hover-style-2 wow fadeInLeft">
                    <a href="#">
                        <img src="/163.jpg" alt="Banner Image">
                ...
                <div class="banner-content-3 wow fadeInRight">
                    <div class="banner-inner-content">
                        ...
                        <span></span>
                        <p class="desc-one">
                        Toutici.tn est un site e-commerce de vente en ligne opérant sur le marché tunisien, et qui propose des milliers de produits et services aux meilleurs offres de prix .
                            <br>
                        Toutici.tn Soldes: Les derniers produits électroniques et de mode en ligne à moindre coût. Achat en ligne parmi des millions de produits en stock. Achetez maintenant et économisez! Voir toutes les offres. Coupons. Électronique. Satisfaction garantie. Livraison gratuite.
                        </p>
                        ...
                        <div class="col-lg-12">
                            <div class="banner-inner-content-4 wow fadeInRight h-100">
                                ...
                                <h4 class="small-title-3 text-uppercase">AVEC LE CODE:</h4>
                                    <h4 class="large-title text-uppercase text-white">Toutici</h4>
        ...
        <div class="banner-thumb-area hover-style background-4">
            <div class="demo-image">
                <a href="shop-fullwidth.html">
                    <img src="{{asset('assets\images\b2.jpg')}}" alt="fashion-image" class="img-full">
                    <div class="banner-overlay"></div>
                </a>
            </div>
        ...
        <div class="product-slider wow fadeInUp">
            <div class="product-section">
                <div class="section-title">
                    <h1 class="heading-4 text-uppercase">Inforamatique</h1>
                </div>
                ...
                <div class="col-12">
                    <div class="newsletter-box text-center">
                        ...
                        <form class="mc-form ml-auto mr-auto" method="get" action="{{ url('/Client/Commande')}}">
                            <input type="text" id="mc-email" class="email-box" placeholder="Entrez votre code commande" name="code_commande" value="Toutici-">
    ...
    <div class="new-arrival-3 d-flex">
        <div class="product-slider wow fadeInUp">
            <div class="product-section">
                <div class="section-title">
                    <h1 class="heading-4 text-uppercase">Animaux</h1>
                </div>
                <div class="mgana-product-tab">
                    <div class="mgana-element-carousel custom-dots blog-slider_dots" data-slick-options='{
                    "slidesToShow": 3,
        ...
        <div class="banner-thumb-area hover-style background-4">
            <div class="demo-image">
                <a href="shop-fullwidth.html">
                    <img src="{{asset('assets/images/b1.jpg')}}" alt="fashion-image" class="img-full">
                    <div class="banner-overlay"></div>
                </a>
            </div>
            <div class="demo-content text-center">
