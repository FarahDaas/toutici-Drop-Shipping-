            ...
            <div class="container">
                ...
                <div class="">
                    <div class="form-group">
                                     <input type="recherche" class="form-control col-4" placeholder="Region : "  name="region" id="test">
                    <input type="text" class="form-control col-4" >
                                </div>
                            <div class="mapdiv">
                                
                                <svg  version="1.2" viewbox="0 0 1000 2158" width="250" xmlns="http://www.w3.org/2000/svg">
                                <a xlink:title="Tozeur" xlink:href="" id='Region Tozeur' name='tozeur'>
                                ...
                                <a xlink:title="Tunis" xlink:href=""  id='Region Tunis' name='tunis'>
                                ...
                                <a xlink:title="Beja" xlink:href=""  id='Region Beja' name='beja'>
                                ...
                                <a xlink:title="Ben Arous" xlink:href=""  id='Region Benarous' name='ben_arous'>
                                ...
                                <a xlink:title="Bizerte" xlink:href=""  id='Region Bizert' name='bizert'>  
                                ...
                                <a xlink:title="Jendouba" xlink:href=""  id='Region Jendouba' name='jendouba'>
                                ...
                                <a xlink:title="Nabeul" xlink:href="" id='Region Nabeul' name='nabeul'>
                                ...
                                <a xlink:title="Ariana" xlink:href="" id='Region Ariana' name='ariana'>
                                ...
                                <a xlink:title="Al kef" xlink:href="" id='Region Alkef' name='al_kef'>
                                ...
                                <a xlink:title="Kaserine" xlink:href="" id='Region Kaserine' name='kaserine'>
                                ...
                                <a xlink:title="Gabes" xlink:href="" id='Region Gabes'name='gabes'>
                                ...
                                <a xlink:title="Gafsa" xlink:href="" id='Region Gafsa' name='gafsa'>
                                ...
                                <a xlink:title="Sidi Bouzid" xlink:href="" id='Region Sidibouzid' name='sidi_bouzid'>
                                ...
                                <a xlink:title="Sfax" xlink:href="" id='Region Sfax' name='sfax'>
                                ...
                                <a xlink:title="Seliana" xlink:href="" id='Region Seliana' name='seliana'> 
                                ...
                                <a xlink:title="Mahdia" xlink:href="" id='Region Mahdia' name='mahdia'>
                                ...
                                <a xlink:title="Monastir" xlink:href="" id='Region Monastir' name='monastir'>
                                ...
                                <a xlink:title="Kairouane" xlink:href="" id='Region Kairouane' name='kairouane'>
                                ...
                                <a xlink:title="Sousse" xlink:href="" id='Region Sousse' name='sousse'>
                                ...
                                <a xlink:title="Zaghouane" xlink:href="" id='Region Zaghouane' name='zaghouane'>
                                ...
                                <a xlink:title="Mednine" xlink:href="" id='Region Mednine' name='mednine'>
                                ...
                                <a xlink:title="kebili" xlink:href="" id='Region Kebili' name='kebili'>
                                ...
                                <a xlink:title="Tataouine" xlink:href="" id='Region Tataouine' name='tataouine'>
                            ...
                            <br>
                            <div class="mapdiv form-group new-div" >
                                    <label><strong>Région</strong></label>
                                    <select name='region_selectione'class="form-control">
                                        <option value=1  class="active">Nabeul</a>
                                        <option  value=2 >Tunis</option>
                                        <option value=3 >Manouba</option>
                                        <option value=4 >Ben Arous</option>
                                        <option value=5 >Zaghouane</option>
                                        <option value=6 >Ariana</option>
                                        <option value=7 >Bizert</option>
                                        <option value=8 >Beja</option>
                                        <option value=9 >Jendouba</option>
                                        <option value=10 >Al Kef</option>
                                        <option value=11>Gasrine</option>
                                        <option value=12 >Gafsa</option>
                                        <option value=13 >Tozeur</option>
                                        <option value=14 >Kebili</option>
                                        <option value=15>Tataouine</option>
                                        <option value=16>Mednine</option>
                                        <option value=17>Gabes</option>
                                        <option value=18>Sfax</option>
                                        <option value=19>Sousse</option>
                                        <option value=20 >Mahdia</option>
                                        <option value=21>Monastir</option>
                                        <option value=22>Kairouane</option>
                                        <option value=23>Sidi Bouzid</option>
                                        <option value=24>Seliana</option>
