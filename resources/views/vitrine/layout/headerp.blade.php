                    ...
                    <div class="col-lg-12">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-sm-6">
                                ...
                                <a href="{{ url('/')}}">
                                        <img class="img-full" src="{{URL::asset('assets\images\tci.png')}}" alt="Header Logo">
                                </a>
                        </div>
                            </div>
                            <div class="col-xl-8 position-static d-none d-xl-block">
                                <nav class="main-nav d-flex justify-content-center">
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a href="{{ url('/Boutique')}}#propos">
                                                <span class="menu-text">Boutique En Ligne</span>
                                        ...
                                        <li>
                                            <a href="{{ url('/articles')}}">
                                                <span class="menu-text">  Devenir Un partenaire</span>
                    ...
                    <div class="col-lg-12">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-sm-6">
                                <div class="header-logo justify-content-sm-start justify-content-xl-center justify-content-lg-center">
                                <a href="{{ url('/')}}">
                                        <img class="img-full" src="{{URL::asset('assets/images/tt.png')}}" alt="Header Logo">
                                </a>
                        </div>
                            </div>
                            <div class="col-xl-8 position-static d-none d-xl-block">
        ...
        <div class="offcanvas-menu_wrapper" id="offcanvasMenu">
            <div class="offcanvas-menu-inner">
                ...
                <div class="offcanvas-inner_nav">
                    <ul>
                        <li>
                            <a href="{{ url('/')}}#propos">Accueil</a>
                        </li>
                        
                        <li>
                            <a href="{{ url('/Boutique')}}">Boutique En Ligne</a>
                        </li>
                        <li>
                            <a href="{{ url('/articles') }}">Service</a>
                        </li>
                        <li>
                ...
                <div class="offcanvas-inner_banner">
                    <div class="inner-img">
                        <a href="#">
                            <img class="img-full" src="{{URL::asset('assets/images/tt.png')}}" alt="Offcanvas Inner Banner">
                        </a>
                    </div>
                </div>
            ...
            <div class="offcanvas-menu-inner">
                ...
                <nav class="offcanvas-navigation">
                    <ul class="mobile-menu">
                        ...
                        <li class="menu-item-has-children">
                            <a href="{{ url('/Boutique')}}">
                                <span class="mm-text">Boutique En Ligne</span>
                            </a>
                        </li>
