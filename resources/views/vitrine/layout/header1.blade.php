            ...
            <div class="container">
                <div class="header__left">
                    <div class="menu--product-categories">
                        <div class="menu__toggle"><i class="icon-menu"></i><span> Toutes les Categories</span></div>
                        <div class="menu__content">
                            <ul class="menu--dropdown">
                                @foreach($cat as $item)
                                <li style="display: flex;margin-button:5px">
                                    <img src="{{asset('/img/categorie/'.$item->icon)}}" style="margin-right: 5px;width: 40px;">
                                    <a href="#"> {{$item->nom}}</a>
                                </li>
                                @endforeach
                    ...
                    </div><a class="ps-logo" href="/"><img src="{{asset('vitrine/img/tci.png')}}" alt=""></a>
                </div>
                ...
                <div class="header__right">
                    <div class="header__actions"><a class="header__extra" href="#"><i class="icon-chart-bars"></i><span><i>0</i></span></a><a class="header__extra" href="#"><i class="icon-heart"></i><span><i>0</i></span></a>
                        ...
                        <div class="ps-block--user-header">
                            ...
                            <div class="ps-block__right"><a href="my-account.html">Login</a><a href="#">Devenir  partenaire</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <nav class="navigation">
            <div class="container">
                <div class="navigation__left">
                    <div class="menu--product-categories">
                        <div class="menu__toggle active"><i class="icon-menu"></i><span> Toute les categories</span></div>
                ...
                <div class="navigation__right">
                   ...
                   <ul class="navigation__extra">
                        ...
                        <li>
                            <a href="#"><img src="img/flag/en.png" alt="">Bon Plan</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="navigation--mobile">
            ...
            <div class="navigation__right">
                <div class="header__actions">
                    ...
                    <div class="ps-block--user-header">
                        <div class="ps-block__left"><i class="icon-user"></i></div>
                        <div class="ps-block__right"><a href="my-account.html">Login</a><a href="#">Devenir un partenaire</a></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="ps-search--mobile">
            <form class="ps-form--search-mobile" action="http://nouthemes.net/html/martfury/index.html" method="get">
                <div class="form-group--nest">
                    <input class="form-control" type="text" placeholder="Cherchez quelque chose......">
